...
TYPE="alien"
THEME="nebula.css"
DOMAIN="https://github.com/timdevops2021/theme.park" #if you update the domain after the script has been run, You must disable and re enable JS or the whole theme.  
ADD_JS="true"
